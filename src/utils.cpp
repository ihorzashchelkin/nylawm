...
void wm::utils::FormatAtomName(std::ostream& out, xcb_ewmh_connection_t& ewmh, const xcb_atom_t atom)
{
    if (atom)
    {
...
void wm::utils::FormatXCBError(std::ostream& out, xcb_errors_context_t* error_context, const xcb_generic_error_t* error)
{
